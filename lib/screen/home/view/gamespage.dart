...
import '../provider/playstoreprovider.dart';
          ...
          children: [
            InkWell(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    color:
                        ProviderFalse!.c1 ? Colors.green.shade50 : Colors.white,
            ...
            InkWell(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    color:
                        ProviderFalse!.c2 ? Colors.green.shade50 : Colors.white,
                    borderRadius: BorderRadius.circular(6),
                    border: Border.all(color: Colors.black12)),
                alignment: Alignment.center,
                child: Text(
            ...
            InkWell(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    color:
                        ProviderFalse!.c3 ? Colors.green.shade50 : Colors.white,
                    borderRadius: BorderRadius.circular(6),
                    border: Border.all(color: Colors.black12)),
                alignment: Alignment.center,
                child: Text(
            ...
            InkWell(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    color:
                        ProviderFalse!.c4 ? Colors.green.shade50 : Colors.white,
                    borderRadius: BorderRadius.circular(6),
                    border: Border.all(color: Colors.black12)),
                alignment: Alignment.center,
                child: Text(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: ClipRRect(
                            borderRadius: BorderRadius.circular(9),
                            child: Image.asset(
                              "${ProviderTrue!.allapps[index].image}",
                            )),
                      ),
                      SizedBox(
                        width: 2.w,
